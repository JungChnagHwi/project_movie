<template>
  <div>
    ...
    <div id="recentModal" class="modal" @click="closeModalOutside">
...
const getMovies = function () {
  axios({
    method: 'GET',
    url: `http://127.0.0.1:8000/movies/recent/`,
  })
  .then((res) => {
...
function openModal(movie) {
  ...
  document.getElementById('recentModal').style.display = 'block'
}
...
function closeModalOutside(event) {
  if (event.target === document.getElementById('recentModal')) {
    closeModal();
  }
}
