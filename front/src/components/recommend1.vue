<template>
  <div>
    ...
    <div id="topratedModal" class="modal" @click="closeModalOutside">
...
const getMovies = function () {
  axios({
    method: 'GET',
    url: `http://127.0.0.1:8000/movies/toprated/`,
  })
  .then((res) => {
...
onMounted(() => {
  getMovies();
  cardList.value = document.getElementById('cardList'); // cardList 초기화
});
...
function closeModalOutside(event) {
  if (event.target === document.getElementById('topratedModal')) {
    closeModal()
  }
}
